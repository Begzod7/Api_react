        ...
        <div className='full'>
            ...
            <div className='container'>
                ...
                <div className="row m-2 p-4">
                    ...
                    {webinars.map((item) => {
                        return <div key={item.id} className="col-sm-6 col-md-3 v my-2 webinar" id='webinar' data-aos="zoom-out-down" data-aos-duration="1500">
                            <div className="card shadow-sm w-100" style={{ height: '430px', borderRadius: '10px', boxShadow: '0 0 10px rgb(51 51 51 / 15%)' }}>
                                <div className="card-body">
