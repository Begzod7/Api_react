...
const Header = () => {
    return (
        ...
        //     <div classNameName="container top_head">
        //         <div classNameName="address_left">
        //             <p ><FcCallback /> (+88) 1990 6886</p>
        //             <p> | </p>
        //             <p><FaRegEnvelope /> agency@example.com</p>
        //         </div>
        //         <div classNameName="address_left">
        //             {/* <p><span>Hover over me!</span><BiChevronDown />
        //                 <h6>I will show on hover</h6>
        //             </p> */}
        ...
        //         </div>
        //     </div>
        //     <div classNameName="tops">
        //         <nav className="navbar navbar-expand-lg ">
        //             <div className="container-fluid">
        //                 <Link to="/">
        //                     <h3><img src="https://www.bimm-research.at/wp-content/uploads/2020/10/bimm_logo_webtop.png" style={{ height: '50px' }} /></h3>
        //                 </Link>
        ...
        //                         </li>
        //                         <li className="nav-item">
        //                             <Link to="/online" style={{ color: 'black' }}>Online</Link>
        //                         </li>
        //                         <li className="nav-item dropdown">
        //                             <Link to="#" classNameName="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" style={{ color: 'black' }}>Kurs</Link>
